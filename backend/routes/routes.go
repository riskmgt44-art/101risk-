...
func RegisterRoutes(r *mux.Router) {
	...
	// INDIVIDUAL USER ROUTES - THESE WERE MISSING
	...
	// ====================
	// VIEWER RISK ENDPOINTS (Read-Only)
	// ====================
	...
	// ====================
	// USER PROFILE ROUTES (Protected versions)
	// ====================
	...
	// These already exist in protected routes but can also be public
